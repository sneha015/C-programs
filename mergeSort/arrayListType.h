...
public:
   ...
   void insertEnd(const elemType& insertItem);
    ...
    void insertionSort();
    void quickSort();
    void quickRecSort(int start, int end);
...
template <class elemType>
void arrayListType<elemType>::swap(int loc1, int loc2)
{
	elemType temp;
	temp = list[loc1];
	list[loc1] = list[loc2];
...
template <class elemType>
int arrayListType<elemType>::partition(int start , int end)
{
	elemType pivot;
...
{
   quickRecSort(0, length-1);
}

template <class elemType>
void arrayListType<elemType>::quickRecSort(int start , int end)
{
	int pivotIndex;
	if(start<end)
	{
		pivotIndex = partition(start , end);
		quickRecSort(start, pivotIndex-1);
		quickRecSort(pivotIndex+1, end);
	}
}
